...
2. Click **Import…** in the menu bar window. A separate import window opens — use it to pick or drop a file. The menu bar panel closes when you click elsewhere; the import window stays open.
